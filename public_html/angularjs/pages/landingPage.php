...
<div class="row">
	<div class="col-md-5">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<label for="modalLoginForm" class="control-label">Enter your email address and password
							here</label>
						<form class="form-inline" id="modalLoginForm" name="modalLoginForm"
								ng-submit="sendLogin(loginData, loginData.$valid);">
		...
		<div class="container">
			<a id="buttonSpacer" href="public_html/angularjs/templates/adminSignUpForm.php">Sign Up</a>
		</div>
		<div class="row">
		<div class="col-md-12"></div>
				<!-- sign up -->

			<!-- temp addschedule button -->

			<a href="public_html/angularjs/templates/addScheduleForm.php"> Temp Link to Add Schedule form</a>
