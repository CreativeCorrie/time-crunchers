...
<div class="modal-body">
	<form id="modalLoginForm" name="modalLoginForm" ng-submit="submit(login, modalLoginForm.$valid);" novalidate>
		...
		<button type="submit" class="btn btn-info" ng-disabled="modalLoginForm.$invalid">Log In</button>
